...
/* harmony import */ var _functions_dropdown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions/dropdown */ "./src/js/functions/dropdown.js");
/* harmony import */ var _functions_dropdown__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_functions_dropdown__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _functions_mobile_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/mobile-menu */ "./src/js/functions/mobile-menu.js");
/* harmony import */ var _functions_loanreq_tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/loanreq-tabs */ "./src/js/functions/loanreq-tabs.js");
/* harmony import */ var _functions_loanreq_tabs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_functions_loanreq_tabs__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _functions_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/map */ "./src/js/functions/map.js");
/* harmony import */ var _functions_map__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_functions_map__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _functions_calc__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/calc */ "./src/js/functions/calc.js");
/* harmony import */ var _functions_calc__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_functions_calc__WEBPACK_IMPORTED_MODULE_4__);



 // отключено: карта через bitrix:map.yandex.view
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_load_check__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions/load-check */ "./src/js/functions/load-check.js");
/* harmony import */ var _functions_load_check__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_functions_load_check__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _functions_resize_check__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/resize-check */ "./src/js/functions/resize-check.js");
/* harmony import */ var _functions_resize_check__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_functions_resize_check__WEBPACK_IMPORTED_MODULE_1__);
...
const calc = () => {
  ...
  if (phoneInput) {
    __webpack_require__.e(/*! import() */ "vendors-node_modules_inputmask_dist_inputmask_js").then(__webpack_require__.t.bind(__webpack_require__, /*! inputmask */ "./node_modules/inputmask/dist/inputmask.js", 23)).then(({
      default: Inputmask
    }) => {
      new Inputmask("(+7)|(8) (999) 999-99-99", {
        placeholder: "0"
      }).mask(phoneInput);
    });
  }
...
/***/ "./src/js/functions/load-check.js"
/*!****************************************!*\
  !*** ./src/js/functions/load-check.js ***!
  \****************************************/
() {
...
/***/ "./src/js/functions/loanreq-tabs.js"
/*!******************************************!*\
  !*** ./src/js/functions/loanreq-tabs.js ***!
  \******************************************/
() {
...
function initMap() {
  ...
  const placemarkKhimki = new window.ymaps.Placemark(khimkiCoords, {
    hintContent: "г. Химки, ул. Панфилова, д. 37",
    balloonContent: "<strong>Офис в Химках</strong><br>ул. Панфилова, д. 37, этаж 4, офис 14"
  }, pinIcon);
  const placemarkMoscow = new window.ymaps.Placemark(moscowCoords, {
    hintContent: "г. Москва, проспект Рязанский, д. 10, стр. 18",
    balloonContent: "<strong>Офис в Москве (ЮВАО)</strong><br>проспект Рязанский, д. 10, стр. 18, этаж 10, кабинет 6"
  }, pinIcon);
...
/***/ "./src/js/functions/mobile-menu.js"
/*!*****************************************!*\
  !*** ./src/js/functions/mobile-menu.js ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/js/functions/resize-check.js"
/*!******************************************!*\
  !*** ./src/js/functions/resize-check.js ***!
  \******************************************/
() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   _slide: () => (/* binding */ _slide)
/* harmony export */ });
const _slide = {};
...
_slide.toggle = (target, duration = 500) => !target.offsetParent ? _slide.down(target, duration) : _slide.up(target, duration);
...
/* harmony import */ var _functions_slide__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/slide */ "./src/js/functions/slide.js");
...
new swiper_bundle__WEBPACK_IMPORTED_MODULE_4__["default"](".swiper-hero", {
  loop: false,
  pagination: {
    el: ".swiper-pagination"
  },
...
new swiper_bundle__WEBPACK_IMPORTED_MODULE_4__["default"](".swiper-client", {
  loop: false,
  spaceBetween: 32,
  navigation: {
...
new swiper_bundle__WEBPACK_IMPORTED_MODULE_4__["default"](".swiper-reviews", {
  loop: false,
  spaceBetween: 32,
  navigation: {
...
document.querySelectorAll(".faq-spoilers__item").forEach(item => item.lastElementChild.style.display = "none");
addEventListener("click", event => {
  ...
  if (item.classList.contains("faq-spoilers__item_active")) {
    ...
    _functions_slide__WEBPACK_IMPORTED_MODULE_5__._slide.up(content);
  } else {
    if (item.parentElement._openedSpoiler) {
      item.parentElement._openedSpoiler.classList.remove("faq-spoilers__item_active");
      _functions_slide__WEBPACK_IMPORTED_MODULE_5__._slide.up(item.parentElement._openedSpoiler.lastElementChild);
    }
    item.classList.add("faq-spoilers__item_active");
    item.parentElement._openedSpoiler = item;
    _functions_slide__WEBPACK_IMPORTED_MODULE_5__._slide.down(content);
  }
});
const buttonsArticles = document.querySelectorAll(".articles__button");
new swiper_bundle__WEBPACK_IMPORTED_MODULE_4__["default"](".swiper-articles", {
  loop: false,
  spaceBetween: 32,
  navigation: {
...
function initServicesSlider() {
  ...
  if (isMobile && !servicesSwiper) {
    servicesSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_4__["default"](".services-section__grid", {
      slidesPerView: "auto" /* Карточки займут столько места, сколько указано в их CSS (например, 240px) */,
